...
# aws_region = 'us-east-1'  # This is one of the regions where Bedrock is available
...
service = 'es'
os_url = 'https://' + host
auth = ("waf-master", "1qaz2wsx#EDC") # (username, password)
...
def search_opensearch(query, index_name="cve", k=5):
...
def print_opensearch_sample(index_name="cve", sample_size=5):
    """
...
def call(chat_history):
    # Example usage
    question = "how many cve-2023 problems?"
